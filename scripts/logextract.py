#!/usr/bin/env python2
# Script to extract configuration and shutdown information file a klippy.log file
#
...
class GatherConfig:
    def __init__(self, configs, line_num, recent_lines, logname):
        ...
        self.filename = "%s.configuration%04d.cfg" % (logname, self.config_num)
        self.config_lines = []
        self.comments = []
    ...
    def finalize(self):
        ...
        ch.comments.append(format_comment(self.line_num, "configuration file"))
...
class GatherShutdown:
    ...
    def __init__(self, configs, line_num, recent_lines, logname):
        ...
        if configs:
            ...
            self.comments.append("# configuration %s" % (config.filename,))
        self.stats_stream = []
        self.gcode_stream = []
        self.gcode_state = ''
        self.mcus = {}
...
def main():
    ...
    if handler is not None:
        handler.finalize()
    # Write found configuration files
