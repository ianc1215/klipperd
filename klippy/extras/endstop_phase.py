...
class EndstopPhase:
    def __init__(self, config):
        ...
        # Obtain step_distance and microsteps from stepper configuration section
...
class EndstopPhases:
    ...
    def update_stepper(self, stepper, is_primary):
        ...
        if phase_calc is None:
            # Check if stepper has an endstop_phase configuration section defined
    ...
    def cmd_ENDSTOP_PHASE_CALIBRATE(self, gcmd):
        ...
        gcmd.respond_info(
            "The SAVE_CONFIG command will update the printer configuration\n"
