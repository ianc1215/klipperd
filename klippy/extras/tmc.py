...
class FieldHelper:
    ...
    def set_config_field(self, config, field_name, default):
        # Allow a field to be set from the configuration file
...
class TMCVirtualPinHelper:
    ...
    def setup_pin(self, pin_type, pin_params):
        ...
        if self.diag_pin is None:
            raise ppins.error("tmc virtual endstop requires diag pin configuration")
...
class TMCMicrostepHelper:
    def __init__(self, config, mcu_tmc):
        ...
        if (stepper_config.get('microsteps', None, note_valid=False) is None
            ...
            # Older configuration format with microsteps in tmc configuration section
            ms_config = config
