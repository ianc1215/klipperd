...
######################################################################
# TMC stepper current configuration helper
######################################################################
...
# Helper to setup an spi daisy chain bus from settings in a configuration section
...
class TMC2130:
    def __init__(self, config):
        ...
        # Allow other registers to be set from the configuration
