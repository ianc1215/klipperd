...
configuration, and restart the host software.
...
class Printer:
    ...
    def __init__(self, main_reactor, bglogger, start_args):
        ...
        # Init printer components that must be setup prior to configuration
    ...
    def lookup_object(self, name, default=configfile.sentinel):
        ...
        if default is configfile.sentinel:
            raise self.config_error("Unknown configuration object '%s'" % (name,))
        return default
...
def main():
    usage = "%prog [options] <configuration file>"
