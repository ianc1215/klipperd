...
# Helper code to build a stepper object from a configuration section
...
# Parse stepper gear_ratio configuration parameter
...
# Obtain "step distance" information from a configuration section
