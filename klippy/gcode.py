...
class GCodeDispatch:
    ...
    def __init__(self, printer):
        ...
        self.mux_commands = {}
        self.gcode_help = {}
        # Register commands needed before configuration file is loaded
    ...
    # Low-level G-Code commands that are needed before the configuration file is loaded
    ...
    cmd_RESTART_help = "Reload configuration file and restart host software"

    def cmd_RESTART(self, gcmd):
        self.request_restart('restart')

    cmd_FIRMWARE_RESTART_help = "Restart firmware, host, and reload configuration"
